...
• Cleaning and preparing raw data. • Data transformation • Filtering, sorting, and Excel functions (VLOOKUP and IF) • Pivot Tables and Pivot Charts • Data visualization and dashboard creation • Analyzing purchase trends
